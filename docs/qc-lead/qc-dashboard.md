...
| Mobile | UC250-254 | Xác thực & Quản lý tài khoản | Đăng ký, Quên MK, Cập nhật DN, Cấu hình (UC250-254) | Yes | Specs: Missing<br>WF: Missing<br>Audited: Missing<br>Scenario: Missing<br>TC md: Missing<br>TC xlsx: Missing | Running — Tổng hợp hiểu biết requirement |  |  |  |
| Mobile | UC256 | Xác thực & Quản lý tài khoản | Đăng nhập ứng dụng Mobile | Yes | Specs: Missing<br>WF: Missing<br>Audited: Missing<br>Scenario: Missing<br>TC md: Missing<br>TC xlsx: Missing | Conditionally Ready v1 (Score 77.7/100) |  |  |  |

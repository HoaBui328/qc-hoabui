...
| 5 | Địa bàn mong muốn | Dropdown (Multi-select) | — | x | x | **Quy tắc hiển thị:**<br>- Placeholder: "Chọn địa bàn mong muốn". Danh sách 63 tỉnh/TP. Searchable (CMR-03).<br>- Không giới hạn số lượng. Hiển thị dạng chip/tag.<br>- Inline error nếu bỏ trống: "Vui lòng chọn địa bàn mong muốn" (CMR-03). |
| 6 | Hình thức đầu tư | Dropdown | — | x | — | **Quy tắc hiển thị:**<br>- Placeholder: "Chọn hình thức đầu tư".<br>- Giá trị: 100% vốn nước ngoài / Liên doanh / Hợp đồng BCC / Khác. |
| 7 | Quy mô vốn dự kiến | Textbox (Number) | — | x | — | **Quy tắc hiển thị:**<br>- Placeholder: "Nhập quy mô vốn dự kiến".<br>- Chỉ nhập số. Đơn vị: VNĐ (cố định, hiển thị label bên phải textbox).<br>- Tự động phân tách hàng nghìn bằng dấu phẩy, thập phân bằng dấu chấm (CMR-11).<br>- Tối đa 500 ký tự.<br>- Message lỗi Max length: "Quy mô vốn dự kiến nhập quá ký tự cho phép" (CMR-09). |
| 8 | Quốc gia mong muốn hợp tác | Dropdown (Multi-select) | — | x | — | **Quy tắc hiển thị:**<br>- Placeholder: "Chọn quốc gia mong muốn hợp tác". Danh sách quốc gia từ API. Searchable (CMR-03).<br>- Không giới hạn số lượng. Hiển thị dạng chip/tag. |
...
| 11 | Tổng vốn đầu tư dự kiến | Icon + Label | — | — | — | **Quy tắc hiển thị:**<br>- Icon $ + Số tiền (màu đỏ). Tự động phân tách hàng nghìn bằng dấu phẩy, thập phân bằng dấu chấm (CMR-11). |
...
| 16 | Loại dự án | Dropdown | "Tất cả" | x | — | Placeholder: "Chọn loại dự án". Tất cả / Trong nước / Nước ngoài / Trong & ngoài nước. |
| 17 | Lĩnh vực | Dropdown | "Tất cả" | x | — | Placeholder: "Chọn lĩnh vực". Searchable (CMR-03). |
| 18 | Ngành kinh tế | Dropdown | "Tất cả" | x | — | Placeholder: "Chọn ngành kinh tế". Searchable (CMR-03). |
| 19 | Địa bàn (Tỉnh/TP) | Dropdown | "Tất cả" | x | — | Placeholder: "Chọn địa bàn". 63 tỉnh/TP. Searchable (CMR-03). |
| 20 | Hình thức đầu tư | Dropdown | "Tất cả" | x | — | Placeholder: "Chọn hình thức đầu tư". 100% vốn nước ngoài / Liên doanh / Hợp đồng BCC / Khác. |

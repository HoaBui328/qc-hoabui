...
| 9 | Tổng vốn đầu tư dự kiến | Icon + Label | — | — | — | **Quy tắc hiển thị:**<br>- Icon tiền (₫) + tiền tố "Vốn: " (màu xám) + Số tiền (màu đỏ) + đơn vị "tỷ VNĐ" (màu xám). Font nhỏ. VD: `⊙ Vốn: 8.200 tỷ VNĐ`. Tự động phân tách hàng nghìn bằng dấu phẩy, thập phân bằng dấu chấm (CMR-11). |

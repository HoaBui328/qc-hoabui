...
| 3 | Icon Thông báo (Chuông) | Button (Icon) | — | — | — | **Quy tắc hiển thị:**<br>- Icon chuông trắng + Badge đỏ khi có thông báo mới.<br>**Quy tắc hành động:**<br>- Tap → Trung tâm thông báo. |
...
| # | Tên trường | Kiểu trường | Giá trị mặc định | Được sửa | Bắt buộc | Mô tả/Ghi chú |
|---|---|---|---|---|---|---|
| 3 | Lĩnh vực quan tâm | Dropdown (Multi-select) | — | x | x | **Quy tắc hiển thị:**<br>- Placeholder: "Chọn lĩnh vực quan tâm...".<br>- Cho phép chọn nhiều lĩnh vực. Danh sách từ API danh mục.<br>**Quy tắc hành động:**<br>- Inline error nếu bỏ trống: "Vui lòng chọn [tên trường]" (CMR-09) |
| 4 | Ngành kinh tế | Dropdown (Multi-select) | — | x | — | **Quy tắc hiển thị:**<br>- Placeholder: "Chọn ngành kinh tế...". Searchable (CMR-03). |
| 5 | Địa bàn mong muốn | Dropdown (Multi-select) | — | x | x | **Quy tắc hiển thị:**<br>- Placeholder: "Chọn tỉnh/thành phố...". Danh sách 63 tỉnh/TP. Searchable (CMR-03).<br>- Inline error nếu bỏ trống (CMR-09). |
| 6 | Hình thức đầu tư | Dropdown | — | x | — | **Quy tắc hiển thị:**<br>- Giá trị: 100% vốn nước ngoài / Liên doanh / Hợp đồng BCC / Khác. |
| 7 | Quy mô vốn dự kiến | Textbox (Number) | — | x | — | **Quy tắc hiển thị:**<br>- Chỉ nhập số (CMR-11). Đơn vị: VNĐ hoặc USD (chọn bên cạnh).<br>- Tối đa 500 ký tự (CMR-11). |
| 8 | Quốc gia mong muốn hợp tác | Dropdown (Multi-select) | — | x | — | **Quy tắc hiển thị:**<br>- Danh sách quốc gia từ API. Searchable (CMR-03). |
...
| 13 | Link quảng bá dự án | Link (Tappable) | — | — | — | **Quy tắc hành động:**<br>- Tap → Mở trình duyệt mặc định. Null → Ẩn field. |
...
5. **Thuật toán matching (Hybrid):**
   - Bắt buộc: dự án phải khớp **ít nhất 1 tiêu chí bắt buộc** (Lĩnh vực HOẶC Địa bàn).
...
6. Thất bại → Hiển thị lỗi theo CMR-07.
...
- **AC10:** NĐT nhận push notification khi có dự án mới được gán/matching.

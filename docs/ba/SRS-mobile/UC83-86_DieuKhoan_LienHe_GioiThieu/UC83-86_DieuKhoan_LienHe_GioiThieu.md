...
- **Section "Mục tiêu & Sứ mệnh":** Hiển thị 2 block nội dung bên trong 1 Card.
    - **Sứ mệnh:** Text mô tả sứ mệnh của nền tảng.
    - **Mục tiêu:** Text mô tả mục tiêu của nền tảng. 
...
- **Section "LÃNH ĐẠO CỤC" (Expand/Collapse):**
    ...
    - **Phó Cục trưởng:** Danh sách dạng **Grid 2 cột** chứa tên các Phó Cục trưởng (Ví dụ: Vũ Văn Chung, Nguyễn Anh Tuấn...). Khi số lượng là số lẻ, ô cuối hiển thị bình thường theo cột — không stretch/justify đặc biệt. **Read-only**, không có tương tác tap.
...
| 2026-05-14 | v1.3 → v1.4 | Mục 2.3 — Icon Notice | (Không có) | Bổ sung mô tả hiển thị icon "Notice" (view-only) | Khớp wireframe |
| 2026-05-14 | v1.3 → v1.4 | Mục 2.3 — Mục tiêu & Chức năng | Text mô tả / Danh sách | Bổ sung quy tắc rỗng: hiển thị "Không có dữ liệu" | Áp dụng CMR-14 |
| 2026-05-14 | v1.4 → v1.5 | Mục 2.3 — Icon Thông báo | Nội dung view-only | Cập nhật cách hiển thị và hành động tap chuyển đến màn hình thông báo theo chuẩn UC70 | Cập nhật theo yêu cầu |
| 2026-05-21 | v1.5 → v1.6 | §2.2 Tab VP đại diện row 2 — Empty State | `"Không có dữ liệu"` (thiếu dấu `.`) | `"Không có dữ liệu."` (có dấu `.`) | Align CMR-14 — đồng bộ format với các UC khác |
| 2026-05-23 | v1.6 → v1.7 | §2.2 (UC85) — Xóa block Icon Thông báo | Block "Icon Thông báo: icon chuông có chấm đỏ, tap → màn hình Thông báo" | (Đã xóa) | Icon thông báo là thành phần chung header, mô tả tập trung tại UC Thông báo |
| 2026-05-23 | v1.6 → v1.7 | §2.3 (UC86) — Xóa block Icon Thông báo | Block "Icon Thông báo: icon chuông có chấm đỏ, tap → màn hình Thông báo" | (Đã xóa) | Icon thông báo là thành phần chung header, mô tả tập trung tại UC Thông báo |

...
| 4 | Khu công nghiệp | Card (Icon + Label) | **Quy tắc hiển thị:**<br>- Luôn hiển thị theo cấu hình mặc định; người dùng không được phép tùy chỉnh thứ tự hoặc ẩn/hiện.<br><br>**Quy tắc hành động:**<br>- Tap → Điều hướng đến màn hình Tra cứu Khu công nghiệp (UC2).                                                                                                                                                                                                                            |
...
| 2 | Tab Tin tức  | Button (Tab)   | -                    | —           | -         | **Quy tắc hiển thị:**<br>- Hiển thị Icon Văn bản và text "Tin tức".<br><br>**Quy tắc hành động:**<br>- Tap → Điều hướng đến màn hình Danh sách Tin tức (UC56-57/66-68).<br>- **Refresh:** Mỗi khi tap vào tab, dữ liệu trên màn hình được refresh (tải lại từ đầu).                                                                                                                                                                                                                                                                   |
| 3 | Tab Hướng dẫn sử dụng | Button (Tab)   | -                    | —           | -         | **Quy tắc hiển thị:**<br>- Hiển thị Icon Kính lúp và text "Hướng dẫn sử dụng".<br><br>**Quy tắc hành động:**<br>- Tap → Điều hướng đến màn hình Hub Hướng dẫn sử dụng (UC75).<br>- **Refresh:** Mỗi khi tap vào tab, dữ liệu trên màn hình được refresh (tải lại từ đầu).                                                                                                                                                                                                                                                                                                       |
| 4 | Tab Cấu hình tài khoản | Button (Tab)   | -                    | —           | -         | **Quy tắc hiển thị:**<br>- Hiển thị Icon Bánh răng và text "Cấu hình tài khoản".<br>- Nằm ngoài cùng góc phải Footer.<br><br>**Quy tắc hành động:**<br>- Tap → Điều hướng đến màn hình Cấu hình tài khoản (UC254).<br>- **Refresh:** Mỗi khi tap vào tab, dữ liệu trên màn hình được refresh (tải lại từ đầu).                                                                                                                                                                                                                          |
...
| 2026-05-18 | v4.1 → v4.2 | §2.1 Khung Footer — Tab 2 | Icon Văn bản + text "Thủ tục" → Điều hướng UC69, UC73 | Icon Văn bản + text "Tin tức" → Điều hướng UC56-57/66-68 | Cập nhật Footer theo cấu trúc mới |
| 2026-05-18 | v4.1 → v4.2 | §2.1 Khung Footer — Tab 3 | Icon Bản đồ + text "KCN/KKT" → Điều hướng UC2 | Icon Kính lúp + text "Hướng dẫn sử dụng" → Điều hướng UC75 | Cập nhật Footer theo cấu trúc mới |
| 2026-05-18 | v4.1 → v4.2 | §2.1 Khung Footer — Tab 4 | Icon Bánh răng + text "Cài đặt" → Điều hướng UC249 | Icon Bánh răng + text "Cấu hình tài khoản" → Điều hướng UC254 | Cập nhật Footer theo cấu trúc mới |
| 2026-05-18 | v4.2 → v4.3 | §2.1 Quick Access #4 — Tên mục | "Khu công nghiệp / KKT" → Điều hướng Tra cứu KCN/KKT (UC2) | "Khu công nghiệp" → Điều hướng Tra cứu Khu công nghiệp (UC2) | Đổi tên Quick Access theo yêu cầu |

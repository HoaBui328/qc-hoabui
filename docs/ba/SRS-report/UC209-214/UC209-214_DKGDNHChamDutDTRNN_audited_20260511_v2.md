...
| Bảng 1 - Vốn ĐTRNN (USD) | Number | * | > 0; Phần nguyên max 15 chữ số, phần thập phân max 5 chữ số (tổng 21 ký tự) |
...
| Bảng 2 - Vốn đã chuyển ra NN | Number | * | ≥ 0; Phần nguyên max 15 chữ số, phần thập phân max 5 chữ số (tổng 21 ký tự) |
...
| **Mục 3 & Hành động** | | | |
| Đề xuất, kiến nghị | Textarea | | Max 3000 ký tự |
| Lưu nháp | Button | | Luôn Enabled |
| Xem | Button | | Luôn Enabled. Popup PDF Preview |
| Nộp báo cáo | Button | | Luôn Enabled |
| Hủy | Button | | Luôn Enabled |
...
## CMR Alignment Changelog (v2 — 2026-05-22)

| # | Hạng mục | Thay đổi |
|---|---|---|
| 1 | Numeric precision (Bảng 1, Bảng 2) | 2 chữ số thập phân → 15 chữ số nguyên + 5 chữ số thập phân (tổng 21 ký tự) |
| 2 | Textarea max (Đề xuất, kiến nghị) | 1000 → 3000 ký tự |
| 3 | Buttons | Bổ sung "Luôn Enabled" cho Lưu nháp, Nộp báo cáo, Xem, Hủy |

...
|-------|-------------|---------|--------|
| UC215-220 | Báo cáo về tình hình chuyển vốn ĐTRNN (Mẫu II.6) | 2.0 | Finalized |
...
| 14 | Lập báo cáo > Header | Số văn bản | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Tham chiếu: CMR_06. | UC215-220.2 |
...
| 20 | Lập báo cáo > Bảng 1 | Tên NĐT | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 21 | Lập báo cáo > Bảng 1 | Mã số DN / CCCD | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 22 | Lập báo cáo > Bảng 1 | Mã số GCNĐT / VB ĐKGDNH | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 23 | Lập báo cáo > Bảng 1 | Địa chỉ trụ sở | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 24 | Lập báo cáo > Bảng 1 | Mục tiêu HĐ của dự án | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 25 | Lập báo cáo > Bảng 1 | Vốn chuyển ra NN (USD) | Number | Yes | Null | — | N/A | > 0; Phần nguyên max 15 chữ số, phần thập phân max 5 chữ số (tổng 21 ký tự). Tham chiếu: CMR_05, CMR_06. | UC215-220.2 |
...
| 32 | Lập báo cáo > Bảng 2 | Tên NĐT | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 33 | Lập báo cáo > Bảng 2 | Mã số DN / CCCD | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 34 | Lập báo cáo > Bảng 2 | Mã số GCNĐT / VB ĐKGDNH | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 35 | Lập báo cáo > Bảng 2 | Địa chỉ trụ sở | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 36 | Lập báo cáo > Bảng 2 | Mục tiêu HĐ | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 255 ký tự. Validate: không rỗng. Tham chiếu: CMR_06. | UC215-220.2 |
| 37 | Lập báo cáo > Bảng 2 | Tiền chuyển về VN (USD) | Number | Yes | Null | — | N/A | > 0; Phần nguyên max 15 chữ số, phần thập phân max 5 chữ số (tổng 21 ký tự). Tham chiếu: CMR_05, CMR_06. | UC215-220.2 |
...
| 40 | Lập báo cáo > Đề xuất | Đề xuất, kiến nghị | Textarea | No | Null | Nhập dữ liệu | N/A | Max 3000 ký tự. Tham chiếu: CMR_06. | UC215-220.2 |
| 41 | Lập báo cáo > Buttons | Lưu nháp | Button | N/A | — | — | N/A | Luôn Enabled. Tham chiếu: CF_01. | UC215-220.2 |
| 42 | Lập báo cáo > Buttons | Xem | Button | N/A | — | — | N/A | Mở Popup PDF Preview. Tham chiếu: CF_07.1. | UC215-220.2 |
| 43 | Lập báo cáo > Buttons | Nộp báo cáo | Button | N/A | — | — | N/A | Luôn Enabled. Thực hiện Nộp. Tham chiếu: CF_01. | UC215-220.2 |
...
|----------------|----------|---------------------|-----------|-------------------------------|
| Số văn bản | Yes | Max 255 ký tự | — / 255 | Trường bắt buộc bị bỏ trống: *"Trường bắt buộc"* (V01) |
| Năm báo cáo | Yes | Số nguyên 4 chữ số, ≤ năm hiện tại | 4 / 4 | Sai định dạng: *"Ký tự không hợp lệ..."* (V02) / Bỏ trống: *"Trường bắt buộc"* (V01) |
| Tên NĐT, Mã DN, Địa chỉ, Mục tiêu (Bảng 1, 2) | Yes | Không rỗng nếu dòng có nhập liệu | — / 255 | Bỏ trống: *"Trường bắt buộc"* (V01) |
| Vốn / Tiền chuyển (USD) | Yes | > 0, phần nguyên max 15 chữ số, phần thập phân max 5 chữ số (tổng 21 ký tự) | >0 / — | Âm: *"Ký tự không hợp lệ..."* (V03) |
...
| UX / Navigation | Hỗ trợ Tab Navigation giữa các trường nhập liệu trên form Lập báo cáo theo thứ tự logic từ trên xuống dưới, trái sang phải. | CMR_18 |
...
### 10.2 Dependencies
- Các chuẩn Common Business Rules: CMR_03, CMR_04, CMR_05, CMR_06, CMR_07, CMR_12, CMR_15, CMR_18.
...
| v2.0 | 2026-05-22 | AI Agent | CMR Alignment: Textbox max 50/500→255 (11 fields), Numeric 12+2→15+5 (2 fields), Textarea 1000→3000, thêm "Luôn Enabled" cho nút Lưu nháp/Nộp báo cáo, thêm CMR_18 Tab Navigation, xóa trailing "." trong error messages (T05). |

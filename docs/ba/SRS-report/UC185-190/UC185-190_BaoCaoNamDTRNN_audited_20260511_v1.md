...
|-------|-------------|---------|--------|
| UC185-190 | Báo cáo định kỳ năm tình hình hoạt động dự án ĐTRNN | v1.1 | Draft |

| Author / BA | Approved By | Date Created | Last Updated |
|-------------|-------------|--------------|--------------|
| anh.luu | (Chưa có) | 2026-04-21 | 2026-05-11 |
...
| 4 | Xem Danh Sách | Mã báo cáo | Search bar | No | Null | "Nhập dữ liệu" | N/A | Debounce 300-500ms. Empty State (CS_01, CMR_06). | Danh sách |
| 5 | Lập Báo Cáo > Chọn Dự án | Dự án | Dropdown | Yes | Null | "Chọn dự án" (suy luận) | Danh sách dự án từ API | Gọi API auto-fill các trường sau khi chọn (CF_01). | Tạo mới |
| 6 | Lập Báo Cáo > Phần I | Số điện thoại người làm báo cáo | Textbox | Yes | Từ API profile | "Nhập dữ liệu" | N/A | Cho phép sửa (CMR_06). | Tạo mới |
| 7 | Lập Báo Cáo > Phần I | Email người làm báo cáo | Textbox | Yes | Từ API profile | "Nhập dữ liệu" | N/A | Validate đúng định dạng email (CMR_06). | Tạo mới |
| 8 | Lập Báo Cáo > Phần II | Năm báo cáo | Textbox | Yes | Null | "Nhập dữ liệu" | N/A | Số nguyên 4 chữ số, ≤ năm hiện tại. | Tạo mới |
| 9 | Lập Báo Cáo > Phần II | Số GP... / VB chứng minh quyền ĐTRNN | Textbox | No | Null | "Nhập dữ liệu" | N/A | Tối đa 100 ký tự. | Tạo mới |
...
| 11 | Lập Báo Cáo > Phần II | Cơ quan cấp GP | Textbox | No | Null | "Nhập dữ liệu" | N/A | Trở thành required khi trường #9 có giá trị. | Tạo mới |
| 12 | Lập Báo Cáo > Phần III > N1 | Tiền | Textbox | Yes | Null | "Nhập dữ liệu" | N/A | Nhập x2 cột. Validate ≥ 0, Lũy kế ≥ Năm BC (CMR_05). | Tạo mới |
...
| 14 | Lập Báo Cáo > Phần IV | Lý do / giải pháp | Textarea | Yes | Null | "Nhập dữ liệu" | N/A | Ẩn mặc định. Hiện & Required khi Radio #13 khác "Đúng tiến độ". Max 2000 ký tự. | Tạo mới |
...
| Nút [Lưu nháp] | Enabled. | Click. | Trim khoảng trắng. Validate chọn Dự án. Lưu thành công báo Toast T01. Form Dirty check được lưu. |
| Nút [Nộp báo cáo] | Enabled. | Click. | Trim khoảng trắng. Validate tất cả Mandatory fields (hiện V01 nếu trống). Mở Popup P01. |
...
| 3 | NĐT | Nhập data, bấm [Lưu nháp] | Validate đã chọn dự án. Lưu thành công, báo Toast T01. Trở về DS. Bản ghi trạng thái "Lưu nháp". | Không chọn dự án -> Lỗi V01 (Trường bắt buộc). | Lưu nháp lỗi -> Toast T05. |
...
|----------------|----------|---------------------|-----------|-------------------------------|
| Trường Text/Textarea bắt buộc chung | Yes | CMR_06 | — / 500 | "Trường bắt buộc" (V01) |
| Trường số (Nhóm 1, 3, 4, 5, 6) | Yes | Chỉ nhận số, `.`, `,`, `-` | ≥ 0 | "Ký tự không hợp lệ. Chỉ chấp nhận chữ số, dấu chấm và dấu phẩy" (V03) / "Sai định dạng số." (V04) |
...
| AC-04 | Validate trường "Lý do / giải pháp" | NĐT chọn Tiến độ thực hiện = "Chậm tiến độ". | NĐT không nhập trường "Lý do / giải pháp" và bấm Nộp. | Nộp thất bại. Lỗi inline "Trường bắt buộc" (V01) xuất hiện dưới trường "Lý do / giải pháp". |

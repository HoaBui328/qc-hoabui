...
|-------------|-------------|--------------|--------------|
| quan.trinh | — | 2026-04-24 | 2026-05-15 |
...
| 5 | Khung Lọc | Mã báo cáo | Search bar | No | Null | "Tìm kiếm theo mã báo cáo" | N/A | Tìm theo mã BC. CMR_06, CMR_09. Max 200 ký tự. Debounce 300-500ms (CS_01 Mục 3) | UC spec + CS_01 |
...
| 68 | Phần B > XIII | Nguồn gốc công nghệ sử dụng | Textarea | No | — | — | N/A | Full-width. Không thuộc cấu trúc 2 cột. CMR_06. Max 2000 | UC spec |
| 69 | Phần C | Cập nhật khó khăn, vướng mắc và kiến nghị | Textarea | No | — | "(Nêu cụ thể khó khăn, vướng mắc, kiến nghị và hướng giải quyết)" | N/A | Optional. Hỗ trợ xuống dòng. CMR_06. Max 2000 | UC spec |
...
| Search Mã BC | Enabled. Null | Type: filter real-time (debounce 300-500ms) | Max 200 ký tự. Case-insensitive. CMR_06, CMR_09. Empty: "Không tìm thấy dữ liệu phù hợp" (CS_01 Mục 3) |
...
| #11 Địa chỉ | Enabled. Pre-fill API | Type: edit | Editable. Bắt buộc. Max 500. CMR_06 |
| #12 SĐT | Enabled. Pre-fill API | Type: edit | Editable. Bắt buộc. Max 500. CMR_06 |
| #13 Email | Enabled. Pre-fill API | Type: edit | Editable. Validate @ + domain. Bắt buộc. CMR_06 |
| eForm Editable cells | Enabled. Nền trắng | Type: nhập số. Blur: auto-round 5 decimal | CMR_05. Max 20 ký tự. Mục 2,3: cho phép âm. Còn lại: ≥ 0. Lỗi âm: "Ký tự không hợp lệ. Chỉ chấp nhận chữ số, dấu chấm và dấu phẩy" |
...
| XIII Nguồn gốc CN | Enabled. Optional | Type: textarea | Full-width. Max 2000. CMR_06 |
...
| Max length Number | — | 20 ký tự (bao gồm dấu chấm, phẩy, trừ) | — | — |
...
| Data Integrity | Max length: Textbox 500, Textarea 2000, Number 20, Search 200 | UC spec v1.8 |

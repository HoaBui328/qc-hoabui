...
| 4 | Khung Lọc | Mã báo cáo | Search bar | No | Null | "Tìm kiếm nhanh theo mã báo cáo" | N/A | Tìm theo mã BC. Max 255 ký tự. CMR_06, CMR_09 | UC spec + Screenshot |
...
| Search Mã BC | Enabled. Null | Type: filter real-time | Max 255 ký tự. CMR_06, CMR_09. Placeholder: "Tìm kiếm nhanh theo mã báo cáo" |
...
| Max length | — | Number: 21 ký tự (15 nguyên + 1 dấu chấm + 5 thập phân). Search: 255 ký tự | — | [Tên trường] chỉ được nhập tối đa 15 chữ số phần nguyên và 5 chữ số phần thập phân |
...
| Data Integrity | Max length: Number 21 (15 nguyên + 1 dấu chấm + 5 thập phân), Search 255 | CMR v2.0 |
...
| v3.0 | 2026-05-22 | QC Agent | CMR alignment: Search max 200→255, Number max 20→21 (15 nguyên + 1 dấu chấm + 5 thập phân) + error message, NFR cập nhật theo CMR mới, placeholder tiếng Việt có dấu cho search bar |

...
| 4 | Khung Lọc | Mã báo cáo | Search bar | No | Null | N/A | Placeholder: "Tìm kiếm nhanh theo mã báo cáo". Max 255 ký tự. CMR_06, CMR_09 | UC spec |
...
| 8 | Tab Navigation (Chuyển tab trường nhập liệu) | Tất cả form nhập liệu | All | CMR_18 |
...
| Data Integrity | Max length: Textbox 255, Textarea 3000, Number 21 (15 nguyên + 1 dấu chấm + 5 thập phân), Search 255. CMR_18 | UC spec v1.8 |
...
| v2.0 | 2026-05-22 | QC Agent | CMR alignment: Search max 200→255, NFR summary (Textbox 255, Textarea 3000, Number 21, Search 255), placeholder cụ thể hóa, xóa trailing dot tooltip, thêm Tab Navigation CMR_18 |

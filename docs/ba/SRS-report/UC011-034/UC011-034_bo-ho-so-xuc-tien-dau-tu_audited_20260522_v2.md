...
| **Phiên bản audit** | v2 |
| **Ghi chú phiên bản** | v2: Align CMR — Sửa maxlength (Textbox 500→255, Textarea 2000→3000, Search 200→255, Numeric 20→21), chuẩn hóa placeholder, bỏ dấu `.` cuối error message, cập nhật error format theo CMR chuẩn |
...
|---|---|---|---|---|---|---|---|
| 1 | Thanh tìm kiếm | Search bar | — | Null | "Tìm kiếm nhanh theo mã báo cáo" | — | UC doc #1 |
...
| 25 | Số công văn | Textbox | ✓ | Null | "Nhập Số công văn" | CMR_06, CMR_13 | UC Tab1 #2 |
...
| 57 | (7) Tình hình thực hiện triển khai | Textarea | ✓ | Null | "Nhập Tình hình thực hiện triển khai" | Tooltip chi tiết hướng dẫn nhập | UC Tab3 #12 |
...
| 69 | (6) Mục tiêu dự án | Textarea | ✓ | Null | "Nhập Mục tiêu dự án" | Editable | UC Tab4 #9 |
...
| 76 | (12) Đề xuất | Textarea | — | Null | "Nhập Đề xuất" | Optional | UC Tab4 #15 |
...
| 25 | Số công văn | Enabled | Input text | Bắt buộc. CMR_13: Auto-uppercase, auto-correct, block ký tự không hợp lệ. Max 255 ký tự. Error: "Số công văn không được vượt quá 255 ký tự!" |
...
| 57 | (7) Tình hình thực hiện | Enabled | Input textarea | Bắt buộc. Tooltip ℹ️ hướng dẫn chi tiết. Max 3000 ký tự. Error: "Tình hình thực hiện triển khai không được vượt quá 3000 ký tự!" |
...
| 69 | (6) Mục tiêu dự án | Enabled | Input textarea | Max 3000 ký tự. Error: "Mục tiêu dự án không được vượt quá 3000 ký tự!" |
...
| 73 | (9) Quốc gia | Enabled | Input text | Format: "số thứ tự; số ký hiệu văn bản". Max 255 ký tự. Error: "Quốc gia không được vượt quá 255 ký tự!" |
| 74 | (10) Lĩnh vực | Enabled | Input text | Tương tự (9) |
| 75 | (11) Địa phương | Enabled | Input text | Tương tự (9) |
| 76 | (12) Đề xuất | Enabled | Input textarea | Optional. Max 3000 ký tự. Error: "Đề xuất không được vượt quá 3000 ký tự!" |
...
| CMR_05 | Trường số: chỉ 0-9, dấu trừ, chấm, phẩy. Phần nguyên max 15 chữ số, phần thập phân max 5 chữ số (tổng 21 ký tự). Auto-round half-up khi blur | "Ký tự không hợp lệ..." / "[Tên trường] chỉ được nhập tối đa 15 chữ số phần nguyên và 5 chữ số phần thập phân" |
| CMR_06 | Text/Textarea: auto-trim, case-insensitive search, max 255/3000 ký tự | "Vui lòng nhập [tên trường]" |
...
| A.IV.4 Diện tích | (8) ≤ Tổng DT quỹ đất dự án | "Diện tích đất không được vượt tổng diện tích quỹ đất của dự án" |
| A.IV.4 Trùng | Không trùng cặp NĐT + Dự án trên cùng 1 báo cáo | "Nhà đầu tư này đã được ghi nhận quan tâm đến dự án này" |
| Năm báo cáo | ≥ 1987 | "Năm báo cáo không hợp lệ" |
...
| 3 | Data precision | Phần nguyên max 15 chữ số, phần thập phân max 5 chữ số (tổng 21 ký tự). Auto-round half-up khi blur | ✅ Complete |
| 4 | Max length | Textbox: 255, Textarea: 3000, Number: 21 (15+1+5), Search: 255 ký tự | ✅ Complete |

...
| 2 | **Textarea max (CMR_06 A06):** Tất cả textarea fields khai báo maxlength = 3000 ký tự. Error: `"[Tên trường] không được vượt quá 3000 ký tự"` | Section 5: Bổ sung constraint textarea |

...
| Nút "Lưu nháp" | Enabled | Click | Không validate định dạng hay bắt buộc; chỉ cần ít nhất 1 thông tin có dữ liệu là được lưu nháp. |
| Nút "Nộp báo cáo" | Enabled | Click | Kiểm tra bắt buộc tất cả các trường theo quy tắc; hiển thị lỗi inline đỏ nếu thiếu. |
...
|----------------|----------|---------------------|-----------|-------------------------------|
| Các trường số (VD: Doanh thu, Cột 10-20) | Có | Numeric, >= 0, không cho phép dấu âm ở đầu | - | "Ký tự không hợp lệ. Chỉ chấp nhận chữ số, dấu chấm và dấu phẩy" (CMR_05) |
| Các trường Text | Có | Max 500 ký tự | 1 / 500 | "Trường bắt buộc" (nếu để trống) |
| KKT | Có | Enum / Master data | - | "Trường bắt buộc" |

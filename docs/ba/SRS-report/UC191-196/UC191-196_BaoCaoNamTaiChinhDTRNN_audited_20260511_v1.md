...
|-------|-------------|---------|--------|
| UC191-196 | Báo cáo năm tài chính ĐTRNN | 1.1 | Draft |
...
| 5 | Danh sách > Lọc | Mã báo cáo | Search bar | No | Null | Nhập dữ liệu | N/A | Tìm kiếm mã báo cáo | Giao diện danh sách |
...
| 17 | Tạo mới > Header | Số tài khoản chuyển vốn | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 50 ký tự | Giao diện thêm mới |
| 18 | Tạo mới > Header | Ngân hàng mở tài khoản | Textbox | Yes | Null | Nhập dữ liệu | N/A | Max 200 ký tự | Giao diện thêm mới |
...
| 20 | Tạo mới > Phần I | Mô tả chi tiết tình trạng | Textarea | Yes | Null | Nêu rõ tình trạng hiện tại và lý do nếu tạm ngừng hoặc thanh lý | N/A | Max 1000 ký tự | Giao diện thêm mới |
...
| 23 | Tạo mới > Phần II | 1. Doanh thu (Năm TC) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 24 | Tạo mới > Phần II | 1. Doanh thu (Luỹ kế) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0, Lũy kế ≥ Năm TC | Giao diện thêm mới |
| 25 | Tạo mới > Phần II | 2. Lợi nhuận sau thuế (Năm TC) | Textbox | Yes | Null | Nhập dữ liệu | N/A | Có thể âm | Giao diện thêm mới |
| 26 | Tạo mới > Phần II | 2. Lợi nhuận sau thuế (Luỹ kế) | Textbox | Yes | Null | Nhập dữ liệu | N/A | Có thể âm | Giao diện thêm mới |
| 27 | Tạo mới > Phần II | 2.1. Lợi nhuận được chia của NĐT VN (Năm TC) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0, Nếu 2 > 0 thì 2.1 ≤ 2 | Giao diện thêm mới |
| 28 | Tạo mới > Phần II | 2.1. Lợi nhuận được chia của NĐT VN (Luỹ kế) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0, Nếu 2 > 0 thì 2.1 ≤ 2 | Giao diện thêm mới |
| 29 | Tạo mới > Phần II | 2.1a. + Tái đầu tư ở nước ngoài (Năm TC) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 30 | Tạo mới > Phần II | 2.1a. + Tái đầu tư ở nước ngoài (Luỹ kế) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 31 | Tạo mới > Phần II | 2.1b. + Chuyển về VN (Năm TC) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 32 | Tạo mới > Phần II | 2.1b. + Chuyển về VN (Luỹ kế) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 33 | Tạo mới > Phần II | 2.1c. + Nghĩa vụ với NN VN (VND) (Năm TC) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 34 | Tạo mới > Phần II | 2.1c. + Nghĩa vụ với NN VN (VND) (Luỹ kế) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 35 | Tạo mới > Phần II | 3. Tình hình, tỷ lệ thu hồi vốn (USD) (Năm TC) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 36 | Tạo mới > Phần II | 3. Tình hình, tỷ lệ thu hồi vốn (USD) (Luỹ kế) | Textbox | Yes | Null | Nhập dữ liệu | N/A | ≥ 0 | Giao diện thêm mới |
| 37 | Tạo mới > Phần II | Giải trình nghĩa vụ chuyển LN về nước và nghĩa vụ TC với NN VN | Textarea | Yes | Null | Giải trình theo quy định tại Điều 34 Nghị định 103/2026/NĐ-CP | N/A | Max 2000 ký tự | Giao diện thêm mới |
| 38 | Tạo mới > Phần III | Kiến nghị | Textarea | ⚡ Không rõ | Null | Nhập dữ liệu | N/A | Max 1000 ký tự. ⚠️ Mâu thuẫn: cột Bắt buộc đánh dấu 'x' nhưng Ghi chú ghi "Optional" — cần BA xác nhận (→ Q1) | Giao diện thêm mới |
...
| 41 | Tạo mới > Các Button | Lưu nháp | Button | No | Null | — | N/A | — | Giao diện thêm mới |
| 42 | Tạo mới > Các Button | Xem | Button | No | Null | — | N/A | Xem PDF Preview | Giao diện thêm mới |
| 43 | Tạo mới > Các Button | Nộp báo cáo | Button | No | Null | — | N/A | — | Giao diện thêm mới |
| 44 | Tạo mới > Các Button | Hủy | Button | No | Null | — | N/A | Dirty check → popup CMR_14 nếu form dirty. | Giao diện thêm mới |
...
| Button [Lưu nháp] | Enabled | Click: Validate tối thiểu và lưu. | Lưu dữ liệu vào hệ thống và quay lại màn hình danh sách (nếu là báo cáo đơn lẻ). |
...
|------|-------|--------|------------------------------|-------------------|-------------------------|
| 1 | Nhà đầu tư | Chọn Dự án | Gọi API để điền tự động các trường từ API. | N/A | Gọi API thất bại: Toast "Không thể kết nối đến hệ thống. Vui lòng thử lại sau.", các trường API mở ra cho phép sửa (Enabled). NĐT chọn Dự án đã có báo cáo: Toast lỗi "Báo cáo cho Dự án đã chọn đã được lập bởi...". |
...
| 3 | Nhà đầu tư | Bấm nút [Nộp báo cáo] | Hệ thống kiểm tra validate. Nếu hợp lệ, mở popup xác nhận. | Nhấn Hủy: Đóng popup xác nhận. | Validate lỗi: Hiển thị thông báo màu đỏ "Trường bắt buộc". Dừng thực hiện nộp. Nộp thất bại hiển thị Toast lỗi "Không thể kết nối đến hệ thống...". |
...
|----------------|----------|---------------------|-----------|-------------------------------|
| Trường thông tin bắt buộc | Yes | N/A | N/A | "Trường bắt buộc" |
| Các trường dữ liệu Số | Yes | Số hợp lệ theo quy định | N/A | "Ký tự không hợp lệ. Chỉ chấp nhận chữ số, dấu chấm, dấu phẩy và dấu trừ" / "Sai định dạng số." |
...
| AC-04 | Validate trường bắt buộc khi Nộp | Các trường thông tin bắt buộc bị bỏ trống | Người dùng nhấn [Nộp báo cáo] | Hệ thống hiển thị dòng chữ màu đỏ "Trường bắt buộc" dưới các trường bị bỏ trống và chặn luồng submit. |

...
| 37 | [NĐT VN — Bằng tiền] | Editable (Number) | x | A, B, C | UC221-226.2 |
| 38 | [NĐT VN — Máy móc, thiết bị] | Editable (Number) | x | A, B, C | UC221-226.2 |
| 39 | [NĐT VN — Tài sản khác] | Editable (Number) | x | A, B, C | UC221-226.2 |
...
| 44 | [NĐT NN — Bằng tiền] | Editable (Number) | x | A, B, C | UC221-226.2 |
| 45 | [NĐT NN — Máy móc, thiết bị] | Editable (Number) | x | A, B, C | UC221-226.2 |
| 46 | [NĐT NN — Tài sản khác] | Editable (Number) | x | A, B, C | UC221-226.2 |
| 47 | 2. Vốn vay | Auto-calc row | — | A, B, C | UC221-226.2 |
| 48 | Vay trong nước | Editable (Number) | x | A, B, C | UC221-226.2 |
| 49 | Vay từ công ty mẹ ở nước ngoài | Editable (Number) | x | A, B, C | UC221-226.2 |
| 50 | Vay nước ngoài khác | Editable (Number) | x | A, B, C | UC221-226.2 |

| # | Object / Component | Type | Required | Columns | Source |
|---|---|---|---|---|---|
| 51 | 3. Lợi nhuận tái đầu tư | Editable (Number) | x | A, B, C | UC221-226.2 |
| 52 | II. Doanh thu thuần | Editable (Number) | x | A, B, Locked(C) | UC221-226.2 |
| 53 | III. Giá trị hàng xuất khẩu | Editable (Number) | x | A, B, Locked(C) | UC221-226.2 |
| 54 | IV. Giá trị hàng nhập khẩu | Editable (Number) | x | A, B, Locked(C) | UC221-226.2 |
| 55 | V. Số lao động hiện có | Auto-calc | — | A, Locked(B), Locked(C) | UC221-226.2 |
| 56 | V.1 Lao động Việt Nam | Editable (Number) | x | A, Locked(B), Locked(C) | UC221-226.2 |
| 57 | V.2 Lao động nước ngoài | Editable (Number) | x | A, Locked(B), Locked(C) | UC221-226.2 |
| 58 | VI. Tình hình sử dụng năng lượng | Group header | — | Locked | UC221-226.2 |
| 59 | VI.1 Điện (kWh) | Editable (Number) | x | A, Locked(B), Locked(C) | UC221-226.2 |
| 60 | VI.2 Than (Tấn) | Editable (Number) | x | A, Locked(B), Locked(C) | UC221-226.2 |
| 61 | VI.3 Dầu (Lít) | Editable (Number) | x | A, Locked(B), Locked(C) | UC221-226.2 |
| 62 | VI.4 Khí LNG (m³) | Editable (Number) | x | A, Locked(B), Locked(C) | UC221-226.2 |
| 63 | VI.5 Các loại năng lượng khác | Editable (Number + Text ĐVT) | — | A, Locked(B), Locked(C) | UC221-226.2 |
| 64 | VII. Thuế và các khoản nộp NSNN | Editable (Number) | x | A, B, Locked(C) | UC221-226.2 |
| 65 | VIII. Diện tích đất, mặt nước | Editable (Number) | — | A, B, C | UC221-226.2 |
...
| 69 | Nút [Lưu nháp] | Enabled | Click | Validate tối thiểu (phải chọn Dự án). Toast T01. CF_01 |
| 70 | Nút [Nộp báo cáo] | Enabled | Click | Validate full → Popup P01 → Toast T02. CF_01 |
| 71 | Nút [Nộp] (Danh sách) | Enabled (Lưu nháp) / Disabled (YCCS chưa sửa) | Click | Validate → Popup P01 hoặc mở CF_03 nếu fail. CF_09, CMR_14 |

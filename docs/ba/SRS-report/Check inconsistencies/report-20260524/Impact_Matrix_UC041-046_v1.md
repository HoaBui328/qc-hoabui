...
### 2.1 UC041-046 (Báo cáo tình hình thực hiện Dự án ĐT Quý) - v1.0

| # | Tên File (Link) | Vị trí | Lỗi / Bất đồng bộ phát hiện | Current Text | Target Text | Trạng thái |
|---|---|---|---|---|---|---|
| 21 | [UC041-046_BaoCaoTinhHinhThucHienDuAnDTQuy_v1.0.md](../UC041-046/UC041-046_BaoCaoTinhHinhThucHienDuAnDTQuy_v1.0.md) | UC041-046.2, A-001 Tên dự án/Tên hợp đồng BCC | **[CMR_CONFLICT]** A-001 là Dropdown nhưng không tham chiếu CMR_07 | Chỉ tham chiếu CMR_12 (API fail case) | Thêm "Tham chiếu: CMR_07" (CMR_07: dropdown phải có placeholder "Chọn [tên trường]") | Need to fix |
| 22 | [UC041-046_BaoCaoTinhHinhThucHienDuAnDTQuy_v1.0.md](../UC041-046/UC041-046_BaoCaoTinhHinhThucHienDuAnDTQuy_v1.0.md) | UC041-046.2, Numeric fields (Phần B) | **[NO_DEFECT]** CMR_05 reference đã có cho all numeric fields | Tham chiếu CMR_05 | N/A | OK |
...
### P3 - Khuyến nghị:
1. **UC041-046 A-001:** Tên dự án — thêm CMR_07
